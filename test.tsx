...
//         <p className="text-sm text-center py-4">{`Don't have an account.`}<Link className="text-indigo-500 px-2" href='/register'>Register</Link>
//           / <Link className="text-indigo-500 px-2" href='/'>Home</Link>
//         </p>
//         {/* Social Buttons */}
