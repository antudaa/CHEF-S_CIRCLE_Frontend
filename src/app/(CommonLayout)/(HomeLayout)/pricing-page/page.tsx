    ...
    return (
        <section className="mt-32 py-24 relative">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mb-12">
                    <h2 className="font-manrope text-5xl text-center font-bold text-white mb-4">Suitable pricing plans</h2>
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                    ...
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Regular Plan</h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-4xl font-medium text-gray-900">$10</span>
                        ...
                        <button onClick={() => handlePurchase(10)} className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</button>
                        {/* <!--List End--> */}
                    </div>
                    {/* <!--Pricing Card--> */}
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Pro Plan</h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-4xl font-medium text-gray-900">$30</span>
                                <span className="text-xl text-gray-500 ml-3">|&nbsp; Month</span>
                            </div>
                        </div>
                        {/* <!--List--> */}
                        ...
                        <button onClick={() => handlePurchase(30)} className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</button>
                        {/* <!--List End--> */}
                    </div>
                    {/* <!--Pricing Card--> */}
                    <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
                        <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                            ...
                            <h3 className="font-manrope text-2xl font-bold my-7 text-center text-indigo-600">Yearly Plan</h3>
                            <div className="flex items-center justify-center">
                                <span className="font-manrope text-4xl font-medium text-gray-900">$300</span>
                                <span className="text-xl text-gray-500 ml-3">|&nbsp; Year</span>
                            </div>
                        </div>
                        {/* <!--List--> */}
                        <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                        ...
                        <button onClick={() => handlePurchase(300)} className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-indigo-600 font-semibold text-center w-fit mx-auto group-hover:bg-indigo-600 group-hover:text-white ">Purchase Plan</button>
                        {/* <!--List End--> */}
                    </div>
                </div>
                {/* <!--Grid End--> */}
