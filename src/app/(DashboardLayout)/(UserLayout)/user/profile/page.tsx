                        ...
                        <div className="bg-white shadow rounded-lg p-6">
                            <div className="flex flex-col items-start">
                                ...
                                <h1 className="text-xl font-bold flex gap-4">{userData?.name}
                                    {
                                        userData?.isPremium ? <MdVerified className="my-auto text-blue-500" /> : ""
                                    }
                                </h1>
                                <p className="text-sm font-base text-gray-500">{userData?.email}
                                </p>
                            ...
                            <div className="flex flex-col">
                                ...
                                <ul>
                                    <li className="mb-2 flex justify-between">Followers <span>{userData?.followers?.length}</span></li>
                                    <li className="mb-2 flex justify-between">Following <span>{userData?.following?.length}</span></li>
                                    <li className="mb-2 flex justify-between">Recipes <span>{userData?.recipeCount}</span></li>
                                    <li className="mb-2 flex justify-between">Favourit Recipes <span>{userData?.favouriteRecipeList?.length}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
