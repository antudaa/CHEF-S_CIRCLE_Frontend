import RecipeImage from '@/Assets/Images/RecipeImage_1.jpg';
// import { BorderBeam } from "@/components/magicui/border-beam";
import Image from 'next/image';
import SubscribeButton from '../ui/Buttons/SubscribeButton';
import { ShineBorder } from '../ui/MagicUI/ShineBorder';
            ...
            <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
                ...
                >
                    <div className="grid grid-cols-12 gap-y-11">
                        <div
                            className="col-span-12 lg:col-span-7 py-12 px-4 lg:px-11 bg-white max-lg:rounded-2xl lg:rounded-l-2xl flex flex-col justify-between max-lg:max-w-lg max-lg:mx-auto">
                            <h2 className="font-manrope font-bold text-2xl sm:text-4xl leading-10 text-black mb-9 text-left">Lowest Prices Best Quality
                                Shoppings</h2>
                            ...
                            {/* <a href="javascript:;" className="flex items-center rounded-full py-3 px-5 min-[550px]:w-max w-full justify-center shadow-sm shadow-transparent bg-indigo-600 transition-all duration-500 hover:shadow-indigo-400 hover:bg-indigo-700">
                            ...
                            <span className="px-2 font-semibold text-base text-white">Subscribe Now</span>
                        </a> */}
                            <SubscribeButton />
                        </div>
                        <div className="col-span-12 lg:col-span-5 lg:max-w-md max-lg:mx-auto ">
                            <Image src={RecipeImage} className="w-full h-full max-lg:rounded-3xl lg:rounded-r-2xl object-cover" alt='Recipe Image' />
                            {/* <img src="https://pagedone.io/asset/uploads/1701234779.png" alt="Warehouse image" className="w-full h-full max-lg:rounded-3xl lg:rounded-r-2xl object-cover" /> */}
                        </div>
                    </div>
                </ShineBorder>
            </div>
