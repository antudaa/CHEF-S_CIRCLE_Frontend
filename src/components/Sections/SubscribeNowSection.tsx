                ...
                >
                    <div className="grid grid-cols-12 gap-y-11">
                        <div
                            ...
                            {/* <a href="" className="flex items-center rounded-full py-3 px-5 min-[550px]:w-max w-full justify-center shadow-sm shadow-transparent bg-indigo-600 transition-all duration-500 hover:shadow-indigo-400 hover:bg-indigo-700">
